...
var mock_result_1 = require("../data/mock-result");
var QuizComponent = (function () {
    ...
    QuizComponent.prototype.getQuiz = function () {
        ...
        this.results = mock_result_1.RESULTS;
    };
    ...
    QuizComponent.prototype.getResult = function () {
        var answers = [0, 0, 0];
        var result = "You're smart!";
        ...
        for (var i = 0; i < this.results.length; i++) {
            if (this.results[i].matrix === answers)
                result = this.results[i].quote;
        }
        return result;
    };
